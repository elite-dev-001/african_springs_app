...
//       body: isLoading ? const Center( child: CircularProgressIndicator(),) : myPosts.isEmpty
//           ? const Align(
...
//               post['title'],
//               post['date'],
//               post['thumbnail'], post['active'], post))
...
// }
//
// Widget postList(BuildContext context, String title, String author, String img, bool active, Object post) {
//   return Padding(
...
//           ),
//         ),
//         onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => SinglePost(post: post,))),
...
//       '147132482297155', 'TuC__zwwBXQ764YO3Y_vXr73p00', 'wilsonchinedu');
//
...
//       );
//       Response response = await dio.patch(LiveApis.resetAdminImage + id,
