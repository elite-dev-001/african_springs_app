...
class AllPost extends StatefulWidget {
  const AllPost({Key? key, required this.role, required this.id}) : super(key: key);
  final String role;
  final String id;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: isLoading ? const Center( child: CircularProgressIndicator(),) : allPosts.isEmpty
            ? const Align(
...
Widget postList(BuildContext context, String title, String author, String img, bool active, Object post, String role, String id) {
  return Padding(
    ...
    child: Container(
      ...
      child: ListTile(
        ...
        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => SinglePost(post: post,role: role, id: id,))),
